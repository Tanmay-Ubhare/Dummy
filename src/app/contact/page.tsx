          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-blue-500 mb-1">Phone</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-blue-600 mb-1">Office Address</h3>
            ...
            <div className="bg-blue-50 rounded-lg p-8">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 hover:bg-blue-800 text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-200 cursor-pointer"
                >
                  Send Message
                </button>
